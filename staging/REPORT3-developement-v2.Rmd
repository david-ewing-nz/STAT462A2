...
knitr::opts_chunk$set(cache = FALSE)
  ...
  HELPER_PATH   <- file.path(PROJECT_SUBDIR, HELPER_PATH)
...
HEART_PATH  <- file.path(PROJECT_SUBDIR, "HEART3.Rmd")
COLOUR_PATH <- file.path(PROJECT_SUBDIR, "COLOUR3.Rmd")
